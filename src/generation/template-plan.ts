...
export function createTemplatePlan(spec: ProjectSpec): TemplateDescriptor[] {
  const descriptors: TemplateDescriptor[] = [
    ...
    { outputPath: '.oxlintrc.json', templatePath: 'root/.oxlintrc.json.tpl' },
    ...
    { outputPath: `src/services/${spec.input.pluginSlug}.service.ts`, templatePath: 'root/src/services/feature.service.ts.tpl' },
    { outputPath: `src/controllers/${spec.input.pluginSlug}.controller.ts`, templatePath: 'root/src/controllers/feature.controller.ts.tpl' },
  ...
  if (spec.blueprint.includeWorkerEntry) {
    descriptors.push(
      ...
      { outputPath: `src/worker/${spec.input.pluginSlug}.worker.service.ts`, templatePath: 'root/src/worker/feature.worker.service.ts.tpl' }
    );
  }
